...
def read_data(mode):
    boundary = np.load("/gpfs/share/home/1900011026/2D_deepSDF/data/data_set/{}_boundary_point.npy".format(mode))
...
def evaluate_and_report():
    ...
    onp.save("/gpfs/share/home/1900011026/2D_deepSDF/data/evaluation.npy", evaluation)
    print(evaluation)
    print("done")
